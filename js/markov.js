...
var DnDFileController, M, autre, circle, circlesGroup, colors, dnd, drag_line, force, height, jeu, joueur, keydown, keyup, lastKeyDown, lastNodeId, links, mousedown, mousedown_link, mousedown_node, mousemove, mouseup, mouseup_node, nodes, path, pathsGroup, premier_appel, resetMouseVars, restart, save, selected_link, selected_node, spliceLinksForNode, svg, tick, width;
...
restart = function() {
  var arete, cell, coeff, e, g, i, j, k, len, len1, len2, len3, len4, m, n, o, p, q, r, ref, ref1, ref2, ref3, ref4, ref5, s, sommeLigne, sommet, sommet2, u, v, x, y;
