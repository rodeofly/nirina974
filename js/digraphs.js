...
// set up SVG for D3
var DnDFileController, autre, circle, circlesGroup, colors, dnd, drag_line, force, height, i, j, jeu, joueur, keydown, keyup, lastKeyDown, lastNodeId, links, mousedown, mousedown_link, mousedown_node, mousemove, mouseup, mouseup_node, nodes, path, pathsGroup, ref, resetMouseVars, restart, save, selected_link, selected_node, sgt, spliceLinksForNode, spoiler, statut, svg, tick, width;
...
restart = function() {
  var arete, e, g, k, len, len1, len2, len3, len4, len5, len6, len7, m, n, o, p, passage, q, r, ref1, ref2, ref3, s, sommet, u, v;
  ...
  for (u = 0, len6 = nodes.length; u < len6; u++) {
    ...
    [e, s] = [0, 0];
    for (v = 0, len7 = links.length; v < len7; v++) {
      arete = links[v];
      if (arete.source === sommet && arete.right) {
        s += 1;
      }
