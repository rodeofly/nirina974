...
restart = function() {
  var arete, c1, c2, cell, enscoul, g, k, len, len1, len2, len3, m, n, na, o, p, q, r, ref, ref1, ref2, s, sommet, sommet2, v, x, y;
  // path (link) group
  ...
  enscoul = {};
  for (i = p = 0, ref = lastNodeId; (0 <= ref ? p <= ref : p >= ref); i = 0 <= ref ? ++p : --p) {
  ...
  for (x = q = 0, ref1 = nodes.length; (0 <= ref1 ? q < ref1 : q > ref1); x = 0 <= ref1 ? ++q : --q) {
    for (y = r = 0, ref2 = nodes.length; (0 <= ref2 ? r < ref2 : r > ref2); y = 0 <= ref2 ? ++r : --r) {
      cell = $(`table#matrAdj tr:nth-child(${x + 2}) td:nth-child(${y + 2})`);
      for (s = 0, len3 = links.length; s < len3; s++) {
        arete = links[s];
